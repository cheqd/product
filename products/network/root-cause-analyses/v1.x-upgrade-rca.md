...
On Monday 30th January, the cheqd team initiated a major network upgrade, v1.x, which introduced identity transaction pricing, among other features and fixes to the network [(v1.x changelog available here)](https://product.cheqd.io/products/network/upgrades/2023/v1).
